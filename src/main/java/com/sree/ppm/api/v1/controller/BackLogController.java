...
public class BackLogController {
    ...
    public ResponseEntity<Object> deleteProjectTask(@PathVariable String backlog_id, @PathVariable String pt_id){
        projectTaskService.deleteProjectSeq(backlog_id, pt_id);
